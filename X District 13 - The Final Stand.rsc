...
<savedscenario>
	<meta>
		...
		<modIds>
			...
			<li>1554149030</li>
			<li>927155256</li>
			<li>SimpleSidearms_CE1.6_Patch</li>
			<li>1366888108</li>
			<li>761421485</li>
			<li>1668482377</li>
			<li>935982361</li>
		...
		<modNames>
			...
			<li>Core</li>
			<li>SRTS Expanded</li>
			<li>SRTS Expanded Realism Patch</li>
			<li>HugsLib</li>
			<li>Mod Manager</li>
			<li>RimThemes</li>
			...
			<li>What the hack?!</li>
			<li>[1.0] Advanced Animal Frameworks 3.4</li>
			<li>Giddy-up! Core</li>
			...
			<li>SimpleSidearms - Unofficial CE1.6 Patch</li>
			...
			<li>[KIR]Colored Lights No Microelectronics!</li>
			<li>Damage Indicators</li>
			<li>[1.0] Dire Raids</li>
			<li>Dubs Mint Menus</li>
			<li>Dub's Paint Shop</li>
			<li>Dynamic Diplomacy</li>
			<li>Escape The Rimworld - Vanilla Weapons Reskinned</li>
			...
			<li>Food Alert</li>
			<li>Greenworld</li>
			<li>Hats Display Selection[1.0]</li>
			...
			<li>SF [v1.0] Rain Removes All Filth</li>
			...
			<li>ZiTools</li>
			<li>[Beta]Anime Hair</li>
			<li>[WD] Antibiotics And Painkillers 1.0</li>
			<li>CE Invisible Vests and Backpacks</li>
			<li>[NL] Chibi Body</li>
			<li>[NL] Facial Animation - WIP</li>
			<li>[CP] Chicken Mitchell - Hairstyles (1.0)</li>
			<li>Custom Hit Marker</li>
			<li>Underground Power Conduits</li>
			<li>Custom Mote Maker</li>
			<li>Door Mat R1.0</li>
			...
			<li>Sparkling worlds patchpatch</li>
			...
			<li>[CP] Retro Joy (1.0)</li>
			<li>Ignite Everything</li>
			<li>[Uru] Rim Seraph hair (1.0)</li>
			<li>RimEVE (Music Pack)</li>
			<li>[KV] RimFridge - 1.0</li>
			<li>RimQuest</li>
			<li>Rimsenal - Rimhair</li>
			<li>[SS]Lovely Hair Style</li>
			<li>Eccentric Tech - Foxy's Armory</li>
			<li>Eccentric Tech - Foxy's Armory CE Patch</li>
			<li>Eccentric Tech - Flares</li>
			...
			<li>DontBlockDoorMod[1.0]</li>
			<li>Use Bedrolls</li>
			<li>SimplyMoreFloors</li>
			<li>Quest Tab</li>
			<li>StuffedDoll[1.0]</li>
			<li>Ivory and Jade Carving [1.0]</li>
			<li>Vanilla Furniture Expanded - Art</li>
			<li>[Uru] Touhou Hair (1.0)</li>
			<li>[WD] Vanilla Hairstyles Rebalance 1.0</li>
			...
			<li>Combat Enthusiast's Collection</li>
			<li>Jin-Roh Kerberos Panzer Cop Armor</li>
			<li>[CE 1.6]Girl's Frontline: Sangvis Ferri Weapons</li>
			<li>Girls' frontline Apparel Pack</li>
			<li>[GF]Girls' Frontline Styles - 404 Team</li>
			<li>Defensive Machine Gun Turret Pack</li>
			<li>Rimworld: Spartan Foundry</li>
			<li>Wall Light</li>
			<li>Wall Light - Extended Colors</li>
			<li>Sand Castles</li>
			...
			<li>Tribal know nothing</li>
			<li>Glass+Lights</li>
			<li>Outdoor Lighting</li>
			<li>Designator Shapes</li>
			<li>Ceiling Light [1.0]</li>
			<li>Rotatable Horseshoe Pin</li>
			...
			<li>Lighter Colorful Traits</li>
			<li>Rimsenal</li>
			<li>Rimsenal - Enhanced Vanilla Pack</li>
			<li>Rimsenal - Feral</li>
			<li>Rimsenal - Federation</li>
			<li>Rimsenal - Security pack</li>
			<li>Rimsenal + Combat Extended Compatibility Mega Patch</li>
			<li>Kurin, The Three Tailed Fox</li>
			<li>Kurin, Apparel Fix</li>
			<li>Kurin, General fixes</li>
			<li>Kurin: CE Shield Patch</li>
			<li>Kurin, a bad translation</li>
			<li>Dragonian Race</li>
			<li>Dragonian Race Apparel Patch</li>
			<li>Additional Dragonian Backstories</li>
			<li>Dragonian Race Weapons permit CE and not CE Patch</li>
			<li>Rabbie The Moonrabbit</li>
			<li>Rabbie The Moonrabbit - English Patch</li>
			<li>[1.0] Android tiers</li>
			<li>[1.0] Android tiers - Gynoids</li>
			<li>Android Tiers++ Expansion</li>
			<li>Android Tiers + Vanilla Expanded Medical</li>
			<li>[1.0] Android Resurrection Kit</li>
			<li>Cybernetic Organism and Neural Network</li>
			<li>Sparkling Worlds Extension - BMC Hardcore Patch [1.0]</li>
			<li>PatchPawnsCE</li>
			<li>More Mechanoids</li>
			<li>More Crashed Ship Parts</li>
			<li>SF Green Thumb Returns</li>
			<li>Cassandra Hardcore</li>
			<li>CucumPear's Storytellers</li>
			<li>Gradient Hair</li>
			<li>Hospitality</li>
			<li>Save Our Ship 2</li>
			<li>Save Our Ship 2 - Dub's Bad Hygiene Compatibility Patch</li>
			<li>Save Our Ship 2 - What The Hack Compatibility Patch</li>
			<li>More Planning</li>
			<li>Dark Eclipse</li>
			<li>Tech Advancing</li>
			<li>Technology Blueprints</li>
			<li>TicksPerSecond</li>
			<li>ShowModDesignators</li>
			<li>Graphics Setter</li>
	...
	<scenario>
		<name>X District 13 - The Final Stand</name>
		<summary>Two People Escape the Decamation of their previous District 13. Start with Basic Supplies and with no research. Very Difficult.</summary>
		<description>It All Happened so quickly. Erica's rage descended upon District 13. There was no fighting back. It was a massacre. At least two of you were able to escape - Basic Citizens - In some dusty drop pods from an abandoned structure. You had no time to act. You only have the basic equipment you had on your person.

As you land in a new Sector, you realise you have no idea how to rebuild what your society once had. You were only a Basic Citizen after all. You have to leave. You have to leave this Rimworld. Erica will find you, and eradicate the last members of X District 13.

Research Level: Tribal
Starting Technologies: None
Recommended Storyteller: Erica (Polaris)
Recommended Difficulty: Merciless
Optional: Winter to hit -50c/-58f (Use Axial Tilt in World Gen)
Dev Mode: Not Allowed

This is your Final Challenge. Do what it takes to Survive.</description>
		<playerFaction>
		...
		<parts>
			...
			<li Class="ScenPart_GameStartDialog">
				...
				<text>It All Happened so quickly. Erica's rage descended upon District 13. There was no fighting back. It was a massacre. At least two of you were able to escape - Basic Citizens - In some dusty drop pods from an abandoned structure. You had no time to act. You only have the basic equipment you had on your person.
...
This is your Final Challenge. Do what it takes to Survive.</text>
			...
			<li Class="ScenPart_StartingThing_Defined">
				<def>StartingThing_Defined</def>
				<thingDef>Apparello_Longlylonglong</thingDef>
				<stuff>Leather_Plain</stuff>
				<count>2</count>
			</li>
			<li Class="ScenPart_StartingThing_Defined">
				<def>StartingThing_Defined</def>
				<thingDef>Apparel_CollarShirt</thingDef>
			...
			<li Class="ScenPart_StartingThing_Defined">
				<def>StartingThing_Defined</def>
				<thingDef>Polarisbloc_EmergencyFood</thingDef>
				<count>5</count>
			</li>
			<li Class="ScenPart_DisallowBuilding">
				<def>Rule_DisallowBuilding</def>
				<building>BeamCannonSatellitePodSW</building>
			</li>
			<li Class="ScenPart_DisallowBuilding">
				<def>Rule_DisallowBuilding</def>
				<building>KineticBombardmentSatellitePodSW</building>
			</li>
			...
			<li Class="ScenPart_CreateIncident">
				<def>CreateIncident</def>
				<incident>Quest_PristineRuins</incident>
				<intervalDays>30</intervalDays>
				<repeat>True</repeat>
			</li>
			<li Class="ScenPart_CreateIncident">
				<def>CreateIncident</def>
				<incident>Get_Out_Mod</incident>
				<intervalDays>30</intervalDays>
				<repeat>True</repeat>
			</li>
			...
			<li Class="ScenPart_StartingThing_Defined">
				<def>StartingThing_Defined</def>
				<thingDef>Apparel_Backpack_Invis</thingDef>
				<count>2</count>
			</li>
			<li Class="ScenPart_DisallowBuilding">
				<def>Rule_DisallowBuilding</def>
				<building>TrapSpike</building>
			</li>
			<li Class="ScenPart_DisallowBuilding">
				<def>Rule_DisallowBuilding</def>
				<building>Turret_Jupiter</building>
			</li>
		</parts>
	</scenario>
</savedscenario>