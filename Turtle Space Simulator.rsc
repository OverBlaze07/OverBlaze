...
<savedscenario>
	...
	<scenario>
		<name>Turtle Space Simulator</name>
		<summary>Tired of being given everything in their tribe, 2 Colonists abandon everything they have to prove that they can make it in life. While sneaking out that one fateful night and falling asleep, they awaken to a turtle headbutting their side.. They decide, to send the Turtle into space. </summary>
		<description>You've abandoned your tribe, and adopted a turtle. You decide to start a new colony, and foolishly decide to send the turtle to space. That would surely raise some eyebrows.

Oh and you stole the Jade Game-of-Ur Board.

Research Level: Tribal
Starting Technologies: None
Recommended Storyteller: Any (Reika Suggested)
Recommended Difficulty: Merciless
Optional: Use Axial Tilt in World Gen for wider temperature variance.
Dev Mode: Not Allowed</description>
		<playerFaction>
		...
		<parts>
			...
			<li Class="ScenPart_GameStartDialog">
				...
				<text>You've abandoned your tribe, and adopted a turtle. You decide to start a new colony, and foolishly decide to send the turtle to space. That would surely raise some eyebrows.
...
Dev Mode: Not Allowed</text>
			...
			<li Class="ScenPart_StartingThing_Defined">
				<def>StartingThing_Defined</def>
				<thingDef>Apparel_TribalA</thingDef>
				<stuff>Leather_Panthera</stuff>
				<count>2</count>
			</li>
			<li Class="ScenPart_StartingThing_Defined">
				<def>StartingThing_Defined</def>
			...
			<li Class="ScenPart_StartingThing_Defined">
				<def>StartingThing_Defined</def>
				<thingDef>Apparel_TribalBackpack_Invis</thingDef>
				<stuff>Leather_Patch</stuff>
				<count>2</count>
			</li>
			<li Class="ScenPart_StartingAnimal">
				<def>StartingAnimal</def>
				<animalKind>Tortoise</animalKind>
				<count>1</count>
			</li>
			<li Class="ScenPart_StartingThing_Defined">
				<def>StartingThing_Defined</def>
			...
			<li Class="ScenPart_StartingThing_Defined">
				<def>StartingThing_Defined</def>
				<thingDef>GameOfUrBoard</thingDef>
				<stuff>Jade</stuff>
			</li>
			<li Class="ScenPart_DisallowBuilding">
				<def>Rule_DisallowBuilding</def>
